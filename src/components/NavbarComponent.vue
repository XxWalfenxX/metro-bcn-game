  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900 drop-shadow-md">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <router-link to="/" class="flex items-center">
        <img
          src="/Barcelona_Metro_Logo_negative.svg"
          class="h-8 mr-3 st0 logoMetro"
          alt="Barcelona Metro Logo"
        />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"
          >Juego Metro BCN</span
        >
      </router-link>
      <button
      @click="toggleMenu"
...
<style>
.logoMetro {
  filter: brightness(0) saturate(100%) invert(10%) sepia(100%) saturate(5921%) hue-rotate(351deg)
